...
function SkillButton({ skillIconName, skillText }) {
    return <Reveal><button className='group cursor-pointer border-black lg:w-48 lg:h-48 w-40 h-40 border-2 rounded-lg p-14 transition duration-300 hover:bg-black flex justify-center items-center flex-col '>
